...
void SIMDMemCopy(void* __restrict _Dest, const void* __restrict _Source, size_t NumQuadwords)
{
	...
	{
		case 3: _mm_stream_si128(Dest + 2, _mm_load_si128(Source + 2));
		case 2: _mm_stream_si128(Dest + 1, _mm_load_si128(Source + 1));
		case 1: _mm_stream_si128(Dest + 0, _mm_load_si128(Source + 0));
		default:
			break;
	}
	...
	{
		default:
		case 10: _mm_prefetch((char*)(Source + 36), _MM_HINT_NTA);
		case 9: _mm_prefetch((char*)(Source + 32), _MM_HINT_NTA);
		case 8: _mm_prefetch((char*)(Source + 28), _MM_HINT_NTA);
		case 7: _mm_prefetch((char*)(Source + 24), _MM_HINT_NTA);
		case 6: _mm_prefetch((char*)(Source + 20), _MM_HINT_NTA);
		case 5: _mm_prefetch((char*)(Source + 16), _MM_HINT_NTA);
		case 4: _mm_prefetch((char*)(Source + 12), _MM_HINT_NTA);
		case 3: _mm_prefetch((char*)(Source + 8), _MM_HINT_NTA);
		case 2: _mm_prefetch((char*)(Source + 4), _MM_HINT_NTA);
		case 1: _mm_prefetch((char*)(Source + 0), _MM_HINT_NTA);

			// Do four quadworks per loop to minimize stalls.
			for (size_t i = CacheLines; i > 0; --i)
			{
				// If this is a large copy, start prefetching future cache lines. This also prefetches the
				// triling quadwords that are not part of a whole line.
				if (i >= 10)
