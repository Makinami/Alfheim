...
namespace GameCore
{
    ...
    public:
        ...
        void SetMovementSpeed(float speed) { m_MoveSpeed = speed; m_StrafeSpeed = speed; }
        void SetMovementSpeed(float move_speed, float stafe_speed) { m_MoveSpeed = move_speed; m_StrafeSpeed = stafe_speed; }
